...
Rectangle {
    ...
    Image {
        ...
        width: 36
        height: width
        source: UserMgr.getIcon()===""?"qrc:/MyChat/Icon/userImg_test.jpg":UserMgr.getIcon()
    ...
    Rectangle{
        ...
        MouseArea{
            ...
            onClicked: {
                if(marginPage.curIndex_mask!==2){
                    ...
                    AppState.showPage()
                    AppState.showFriendPage()
                }
                else{
                    AppState.showHome()
                }
                contactMsgRec.visible=false
            }
        }
        ...
        Rectangle{
            id:contactMsgRec
            anchors.right: contactIcon.right
            anchors.rightMargin: -4
            anchors.top: contactIcon.top
            anchors.topMargin: -3
            width: 10
            height: width
            radius: width/2
        ...
        Connections{
            target: TcpMgr
            function onNotifyAddFriend(){
                contactMsgRec.visible=true
            }
        }
    }
